...
if __name__ == "__main__":
    # TEMPORARY INPUT
    # in_bbox = [348900, 16400, 631600, 201580]  # SLO w/o outermost pixels
    # in_bbox = [500000, 110000, 530000, 130000]  # Celjska kotlina
    # in_bbox = [500000, 110000, 504000, 114000]  # 200x200 in 20m
    # in_bbox = [500000, 110000, 500100, 110100]  # XS
    # in_bbox = [599300, 159300, 599400, 159400]  # ref Mura 2017
    # in_bbox = [597540, 154360, 610660, 165000]  # ref Mura 2017
    in_bbox = [597540, 154160, 597600, 154400]


    # Set composite time frame (currently Jan 2019)
    in_start_date = (2017, 3, 1)
    in_end_date = (2017, 3, 31)
    ...
    in_save_dir = ".\\test_Mura-2017-03_v2"
    str_name = "mura_17-03_error"
